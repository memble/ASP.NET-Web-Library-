<%@ Page Language="VB" MasterPageFile="~/Main.master" AutoEventWireup="false" CodeFile="Input.aspx.vb" Inherits="Input" title="Online Library - Input Books" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p>
        <asp:Label ID="Label2" runat="server" Font-Size="X-Large" Text="Input Books"></asp:Label>
    </p>
    <p>
    ...
    <p>
        <asp:Button ID="Button1" runat="server" Text="Input"/>
    &nbsp;</p>
    <p>
