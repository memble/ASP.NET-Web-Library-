        ...
        <table style="width: 106%; height: 254px;">
            <tr bgcolor="#FFE697">
                ...
                <td class="style2" valign="top">
                    <asp:Label ID="Label1" runat="server" Font-Size="X-Large" Text="Log In"></asp:Label>
                    <br />
                    <br />
...
&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="Button2" runat="server" CausesValidation="false" Text="Register New User" />
                    <br />
                    <br />
