...
Partial Class ReturnOnBook
    ...
    Protected Sub DropDownList1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles DropDownList1.SelectedIndexChanged
        ...
        AccessDataSource3.SelectCommand = "SELECT * FROM books WHERE KodeMK = 0 AND Status = 'Borrowed'"
    End Sub
    ...
    Private Sub PopulateData()
        ...
        If paramquery.Length > 0 Then
            basequery += " WHERE Status = 'Borrowed' AND BookingBy = '" & DropDownList1.Text & "' AND " & paramquery & "  "
        Else
            basequery += " WHERE Status = 'Borrowed' AND BookingBy = '" & DropDownList1.Text & "'"
        End If
    ...
    Protected Sub GridView1_SelectedIndexChanging(ByVal sender As Object, ByVal e As GridViewSelectEventArgs) Handles GridView1.SelectedIndexChanging
        ...
        Response.Redirect(String.Format("ReturnOnBookDetails.aspx?kodemk={0}&member={1}", kodemk, user))
    End Sub
