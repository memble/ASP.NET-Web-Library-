<%@ Page Language="VB" MasterPageFile="~/Main.master" AutoEventWireup="false" CodeFile="Search.aspx.vb" Inherits="Search" title="Online Library - Search Books" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p style="height: 28px">
        <asp:Label ID="Label2" runat="server" Font-Size="X-Large" Text="Search Books"></asp:Label>
    </p>
    <p style="height: 84px">
